...
def calculates_results_stats(results_dic):
    ...
    n_match = 0  # Number of matches between pet label & classifier label
    ...
    # Iterate through results_dic to compute statistics
    for key, values in results_dic.items():
        pet_label, classifier_label, is_match, is_dog, is_classifier_dog = values
    ...
    # Compute percentages, avoiding division by zero errors
